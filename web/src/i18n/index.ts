  ...
  en: {
    translation: {
      ...
      usage_stats: {
        ...
        account_guard_title: 'Account Guard',
        account_guard_subtitle: 'Auto-disable accounts on upstream errors and send periodic health alerts. Changes apply live without restart.',
        account_guard_enabled: 'Enabled',
        account_guard_interval: 'Alert interval (seconds)',
        account_guard_interval_invalid: 'Alert interval must be an integer >= 60 seconds.',
        account_guard_disable_codes: 'Auto-disable status codes',
        account_guard_monitor_codes: 'Monitor-only status codes (alert, no disable)',
        account_guard_code_add: 'Add',
        account_guard_code_empty: 'None',
        account_guard_code_invalid: 'Status code must be an integer between 100 and 599.',
        account_guard_channels: 'Alert channels',
        account_guard_channel_add: 'Add channel',
        account_guard_channel_empty: 'No alert channel configured.',
        account_guard_channel_type: 'Type',
        account_guard_channel_enabled: 'Enabled',
        account_guard_channel_telegram: 'Telegram',
        account_guard_channel_webhook: 'Webhook',
        account_guard_telegram_token: 'Bot Token',
        account_guard_telegram_chat_id: 'Chat ID',
        account_guard_webhook_url: 'Webhook URL',
        account_guard_secret_placeholder: 'Enter value',
        account_guard_save_success: 'Account guard settings saved.',
        account_guard_save_failed: 'Unable to save account guard settings.',
  ...
  zh: {
    translation: {
      ...
      usage_stats: {
        ...
        account_guard_title: '号池守护',
        account_guard_subtitle: '上游报错时自动禁用账号并定时发送健康度告警。改动实时生效，无需重启。',
        account_guard_enabled: '启用',
        account_guard_interval: '告警间隔（秒）',
        account_guard_interval_invalid: '告警间隔必须是 ≥ 60 的整数秒。',
        account_guard_disable_codes: '自动禁用状态码',
        account_guard_monitor_codes: '仅监测状态码（告警不禁用）',
        account_guard_code_add: '添加',
        account_guard_code_empty: '无',
        account_guard_code_invalid: '状态码必须是 100–599 之间的整数。',
        account_guard_channels: '告警渠道',
        account_guard_channel_add: '添加渠道',
        account_guard_channel_empty: '尚未配置告警渠道。',
        account_guard_channel_type: '类型',
        account_guard_channel_enabled: '启用',
        account_guard_channel_telegram: 'Telegram',
        account_guard_channel_webhook: 'Webhook',
        account_guard_telegram_token: 'Bot Token',
        account_guard_telegram_chat_id: 'Chat ID',
        account_guard_webhook_url: 'Webhook URL',
        account_guard_secret_placeholder: '请输入',
        account_guard_save_success: '号池守护设置已保存。',
        account_guard_save_failed: '无法保存号池守护设置。',
  ...
  'zh-TW': {
    translation: {
      ...
      usage_stats: {
        ...
        account_guard_title: '號池守護',
        account_guard_subtitle: '上游報錯時自動停用帳號並定時發送健康度告警。變更即時生效，無需重啟。',
        account_guard_enabled: '啟用',
        account_guard_interval: '告警間隔（秒）',
        account_guard_interval_invalid: '告警間隔必須是 ≥ 60 的整數秒。',
        account_guard_disable_codes: '自動停用狀態碼',
        account_guard_monitor_codes: '僅監測狀態碼（告警不停用）',
        account_guard_code_add: '新增',
        account_guard_code_empty: '無',
        account_guard_code_invalid: '狀態碼必須是 100–599 之間的整數。',
        account_guard_channels: '告警渠道',
        account_guard_channel_add: '新增渠道',
        account_guard_channel_empty: '尚未設定告警渠道。',
        account_guard_channel_type: '類型',
        account_guard_channel_enabled: '啟用',
        account_guard_channel_telegram: 'Telegram',
        account_guard_channel_webhook: 'Webhook',
        account_guard_telegram_token: 'Bot Token',
        account_guard_telegram_chat_id: 'Chat ID',
        account_guard_webhook_url: 'Webhook URL',
        account_guard_secret_placeholder: '請輸入',
        account_guard_save_success: '號池守護設定已儲存。',
        account_guard_save_failed: '無法儲存號池守護設定。',
